...
const USB_Descriptor_Device_t PROGMEM DeviceDescriptor =
{
	...
	.SubClass = 0x00,//could be any
	.Protocol = 0x00,//could be any
	.ProductID = 0x2064,//provided by atmel for lufa
	.ReleaseNumber = VERSION_BCD(00.42),//a code version
	.VendorID = 0x03EB,//provided by atmel for lufa
	...
	.Interface =
		{
			...
			.Class                  = 0xff,//vendor specific
			.SubClass               = 0x00,//could be any
			.Protocol               = 0x00,//my protocol, could be any
